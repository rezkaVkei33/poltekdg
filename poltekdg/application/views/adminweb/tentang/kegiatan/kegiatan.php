...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <title>
    <?= isset($title) ? $title : 'Kegiatan - Poltek DG' ?>
</title> 
    ...
    <div class="container-fluid py-2">
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">DATA KEGIATAN</h3>
                    </p>
        ...
        <div class="table-responsive">
          ...
          <!-- Table -->
    <div class="container">
      <a class="btn btn-success btn-sm" href="<?= base_url('kegiatan/tambah_kegiatan'); ?>">
    ...
    <?php if(!empty($kegiatan)) : ?>
        <?php foreach($kegiatan as $data): ?>
            ...
            <td class="text-center">
                ...
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_kegiatan-<?= $data->id_kegiatan; ?>"> 
                <i class="material-symbols-rounded opacity-5">delete</i>
                Hapus
                </button>

              <!-- Modal Hapus Sambutan -->
            <div class="modal fade" id="hapus_kegiatan-<?= $data->id_kegiatan; ?>" tabindex="-1" aria-labelledby="modalLabel>" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-center">
                        ...
                        menghapus Berita <strong><?= $data->nama_kegiatan; ?></strong>?</p>
                      </div>
                      <div class="modal-footer">
                        <a href="<?= base_url('kegiatan/hapus_kegiatan/' . $data->id_kegiatan); ?>" class="btn btn-danger">Ya, Hapus</a> 
