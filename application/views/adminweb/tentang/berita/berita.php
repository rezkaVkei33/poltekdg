...
<main class="admin-landing container my-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold" style="color: #023c5e;" id="pageTitle">DATA BERITA</h2>
        </div>
        <div>
            <a class="btn btn-primary bg-gradient-info" href="<?= base_url('berita/tambah_berita'); ?>">
                ...
                <?php if(!empty($berita)) : ?>
                    <?php foreach($berita as $data): ?>
                        ...
                        <td class="text-center" data-label="Aksi">
                            <a href="<?= base_url('berita/ubah_berita/' . $data->id_berita); ?>" class="btn btn-warning btn-sm text-white"> 
