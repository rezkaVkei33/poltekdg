...
<main class="admin-landing container my-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold" style="color: #023c5e;" id="pageTitle">DATA PENGUMUMAN</h2>
        </div>
        <div>
            <a class="btn btn-primary bg-gradient-info" href="<?= base_url('pengumuman/tambah_pengumuman'); ?>">
                ...
                <?php if(!empty($pengumuman)) : ?>
                    <?php foreach($pengumuman as $data): ?>
                        ...
                        <td class="text-center" data-label="Aksi">
                            <a href="<?= base_url('pengumuman/ubah_pengumuman/' . $data->id_pengumuman); ?>" class="btn btn-warning btn-sm text-white"> 
