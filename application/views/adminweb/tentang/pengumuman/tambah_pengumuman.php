...
<head>
  ...
  <title>
    <?= isset($title) ? $title : 'Tambah Pengumuman - Poltek DG' ?>
</title> 
      ...
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">TAMBAH PENGUMUMAN</h3>
                    </p>
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive">
                <div class="container"> 
                    <form method="POST" action="<?= base_url('pengumuman/simpan_pengumuman'); ?>" enctype="multipart/form-data">
                        <!-- JUDUL -->
