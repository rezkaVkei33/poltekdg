...
<head>
  ...
  <title>
    <?= isset($title) ? $title : 'Ubah Pengumuman - Poltek DG' ?>
</title> 
      ...
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">UBAH PENGUMUMAN</h3>
                    </p>
        ...
        <div class="card-body px-0 pb-2">
          <div class="table-responsive">
                <div class="container"> 
                    <form method="POST" action="<?= base_url('pengumuman/update/' . $pengumuman->id_pengumuman); ?>" enctype="multipart/form-data">
                        <!-- JUDUL -->
                    ...
                    <!-- TANGGAL PENGUMUMAN -->
                     ...
                     <div class="input-group input-group-outline mb-3">
                      ...
                      <div class="input-group input-group-outline mb-3">
                        ...
                        <a href="<?= base_url('pengumuman'); ?>" class="btn btn-secondary">Kembali</a>
                      </div>
                    </form>
                    </div>
                        <!-- konten -->
