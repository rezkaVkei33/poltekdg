...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <title>
    <?= isset($title) ? $title : 'Renstra - Poltek DG' ?>
</title> 
    ...
    <div class="container-fluid py-2">
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">DATA RENCARA STRATEGIS</h3>
                    </p>
        ...
        <div class="table-responsive">
          ...
          <!-- Table -->
    <div class="container">
      <a class="btn btn-success btn-sm" href="<?= base_url('renstra/tambah_renstra'); ?>">
