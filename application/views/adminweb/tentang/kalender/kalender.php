...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <title>
    <?= isset($title) ? $title : 'Kalender Akademik - Poltek DG' ?>
</title> 
    ...
    <div class="container-fluid py-2">
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">DATA KALENDER AKADEMIK</h3>
                    </p>
        ...
        <div class="table-responsive">
          ...
          <!-- Table -->
    <div class="container">
      <a class="btn btn-success btn-sm" href="<?= base_url('kalender/tambah_kalender'); ?>">
    ...
    <table class="table align-items-center mb-0">
      <thead>
        <tr>
          ...
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tahun Akademik</th>
    ...
    <?php if(!empty($kalender_akademik)) : ?>
        <?php foreach($kalender_akademik as $data): ?>
            ...
            <td class="text-center">
                ...
                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_kalender-<?= base_url('kalender/hapus_kalender/' . $data->id_kalender); ?>"> 
                <i class="material-symbols-rounded opacity-5">delete</i>
                Hapus
                </button>

              <!-- Modal Hapus Kalender -->
            <div class="modal fade" id="hapus_kalender-<?= base_url('kalender/hapus_kalender/' . $data->id_kalender); ?>" tabindex="-1" aria-labelledby="modalLabel>" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title text-white" id="modalLabel">HAPUS KALENDER AKADEMIK</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                      </div>
                      <div class="modal-body text-center">
                        <p>Apakah Anda yakin ingin <br>
                        menghapus Kalender Akademik dari <strong><?= $data->judul; ?></strong>?</p>
                      </div>
                      <div class="modal-footer">
                        <a href="<?= base_url('kalender/hapus_kalender/' . $data->id_kalender); ?>" class="btn btn-danger">Ya, Hapus</a> 
        ...
        <?php else: ?>
            <tr>
                <td colspan="6" class="text-center text-danger ">Tidak ada Kalender.</td>
            </tr>
        <?php endif; ?>
    </tbody>
  </table>
