...
<main class="admin-landing container my-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold" style="color: #023c5e;" id="pageTitle">DATA KALENDER AKADEMIK</h2>
        </div>
        <div>
            <a class="btn btn-primary bg-gradient-info" href="<?= base_url('kalender/tambah_kalender'); ?>">
                ...
                <?php if(!empty($kalender_akademik)) : ?>
                    <?php foreach($kalender_akademik as $data): ?>
                        ...
                        <td class="text-center" data-label="Aksi">
                            <a href="<?= base_url('kalender/ubah_kalender/' . $data->id_kalender); ?>" class="btn btn-warning btn-sm text-white"> 
