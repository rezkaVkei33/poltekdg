...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <title>
    <?= isset($title) ? $title : 'Sejarah - Poltek DG' ?>
</title> 
    ...
    <div class="container-fluid py-2">
      <div class="row mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="row">
                  <div class="ms-3">
                    <h3 class="mb-0 h4 font-weight-bolder">DATA SEJARAH</h3>
                    </p>
        ...
        <div class="card-body px-0 pb-2">
          ...
          <!-- Table -->
    <div class="container">
      <a class="btn btn-success btn-sm" href="<?= base_url('sejarah/tambah_sejarah'); ?>">
    ...
    <table class="table align-items-center mb-0">
      <thead>
        <tr>
          ...
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Teks Sejarah</th>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama penulis</th>
