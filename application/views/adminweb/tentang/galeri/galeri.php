...
<main class="admin-landing container my-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div>
            <a class="btn btn-primary bg-gradient-info" href="<?= base_url('galeri/tambah_galeri'); ?>">
                ...
                <?php if(!empty($galeri)) : ?>
                    <?php foreach($galeri as $data): ?>
                        ...
                        <td class="text-center" data-label="Aksi">
                            <a href="<?= base_url('galeri/ubah_galeri/' . $data->id_galeri); ?>" class="btn btn-warning btn-sm text-white"> 
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" class="text-center text-danger ">Tidak ada galeri.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
              </table>
        </div>
        <?php $row_count = count($galeri ?? []); ?>
