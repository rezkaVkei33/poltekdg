...
<main class="admin-landing container my-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-semibold" style="color: #7a561f;">TAMBAH BROSUR</h2>
            <p class="text-muted" style="color: #b68b40 !important;">Lengkapi data brosur dalam Bahasa Indonesia dan Bahasa Inggris.</p>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-semibold" style="color: #7a561f;">TAMBAH BROSUR</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            <div class="modal-body p-4">
                <form id="dataForm" method="post" action="<?= base_url('brosur/simpan_brosur'); ?>" enctype="multipart/form-data">
                    <?php $this->load->view('adminweb/tentang/brosur/_form'); ?>
                </form>
            </div>
