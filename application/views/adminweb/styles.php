...
<meta charset="utf-8"/>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('assets/images/LogoPoltek.png'); ?>"> 
  ...
  <link href="<?= base_url('material-dashboard/assets/css/bootstrap.min.css'); ?>" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  ...
  <link href="<?= base_url('material-dashboard/assets/css/navbar-admin.css'); ?>" rel="stylesheet" />
