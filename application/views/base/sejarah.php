  ...
  <section class="py-16 bg-white">
    ...
    <div class="row mb-5 align-items-start">
      <div class="col-md-4 col-12 d-flex justify-content-center align-items-center">
        <div class="mx-auto d-flex justify-content-center align-items-center"
         style="background: #fff; box-shadow: 0 8px 24px rgba(255,140,0,0.18);">
          <img src="<?= base_url('uploads/sejarah/' . $sejarah->gambar) ?>"
           alt="Foto Sejarah"
      ...
      <div class="col-md-8 col-12 d-flex flex-column justify-content-start">
        <div class="mb-2">
          <h3 class="fw-bold"><?= $sejarah->nama_penulis ?></h3>
          <small class="text-muted"><?= $sejarah->nama_penulis ?> | <?= date('l, j F Y', strtotime($sejarah->tanggal_update)) ?></small>
          <hr class="mb-3">
        </div>
        <div class="flex-grow-1">
          <p class="text-justify" style="text-align: justify;"><?= nl2br($sejarah->teks_sejarah) ?></p>
        </div>
      </div>
      </div>
    </div>
