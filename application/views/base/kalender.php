                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl lg:text-4xl font-bold text-gray-800 mb-4">
                          <?= strtoupper($subtitle ?? 'Kalender Akademik') ?>
                        </h2>
                        <div class="flex justify-center mb-6">
                         ...
                         <?php if (!empty($data_kalender)): ?>
                          ...
                          <div class="bg-white p-4 rounded shadow-sm mb-5">
                            ...
                            <p class="mt-3 text-justify"><?= nl2br($kalender->deskripsi) ?></p>
                            <hr style="border-top: 2px solid #ccc;">
                            <div class="mt-3">
                              <h5 class="fw-semibold">Keterangan:</h5>
                              <ul class="list-unstyled">
                                <li><strong>Tahun Akademik:</strong> <?= $kalender->tahun_akademik ?></li>
                                <li><strong>Tanggal Mulai:</strong> <?= date('d M Y', strtotime($kalender->tanggal_mulai)) ?></li>
                                <li><strong>Tanggal Selesai:</strong> <?= date('d M Y', strtotime($kalender->tanggal_selesai)) ?></li>
                              </ul>
                            </div>
                            <hr style="border-top: 2px solid #ccc;">
                          </div>
