                            ...
                            <div class="broswur-slider-wrapper overflow-hidden rounded-2xl shadow-2xl">
                                <div class="broswur-slider flex transition-transform duration-500">
                                    ...
                                    <div class="broswur-slide w-full flex-shrink-0">
                                        <img src="<?= base_url('assets/images/brosur-1.jpeg') ?>" alt="Brosur Kampus 1" class="w-full max-h-80 object-cover">
                                    </div> 
                                    <!-- Slide 2 -->
                                    <div class="broswur-slide w-full flex-shrink-0">
                                        <img src="<?= base_url('assets/images/brosur-2.jpeg') ?>" alt="Brosur Kampus 2" class="w-full max-h-80 object-cover">
                                    </div>
                                </div>
                            </div>
