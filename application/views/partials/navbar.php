                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class="dropdown-menu">
                                <a href="<?= base_url('base/kalender') ?>">Kalender Akademik</a>
                                <a href="#">SIAKAD</a>
                                <a href="<?= base_url('base/arsip') ?>">Arsip</a>
                            </div>
                        </div>

                        <a href="<?= base_url('base/kontak') ?>" class="text-gray-700 hover:text-amber-600 font-medium transition-colors">Kontak</a>
                        
                        <a href="<?= base_url('base/pendaftaran') ?>" class="bg-gradient-to-r from-amber-400 to-orange-500 text-white px-6 py-2 rounded-full hover:from-amber-500 hover:to-orange-600 transition-all font-medium shadow-lg">
                            Daftar Sekarang
                        </a>
                    </div>
                    ...
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <div class="mobile-dropdown-container">
                            ...
                            <div id="tentang" class="mobile-dropdown pl-4">
                                <a href="<?= base_url('base/sambutan') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Sambutan</a>
                                <a href="<?= base_url('base/sejarah') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Sejarah</a>
                                <a href="<?= base_url('base/visi_misi') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Visi & Misi</a>
                                <a href="<?= base_url('base/renstra') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Renstra</a>
                                <a href="<?= base_url('base/dosen') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Dosen</a>
                            </div>
                        </div>
                        ...
                        <div class="mobile-dropdown-container">
                            ...
                            <div id="prodi" class="mobile-dropdown pl-4">
                                <a href="<?= base_url('base/prodi_si') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">D3 Sistem Informasi</a>
                                <a href="<?= base_url('base/prodi_ph') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">D3 Perhotelan</a>
                            </div>
                        </div>
                        ...
                        <div class="mobile-dropdown-container">
                            ...
                            <div id="akademik" class="mobile-dropdown pl-4">
                                <a href="<?= base_url('base/kalender') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Kalender</a>
                                <a href="" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">SIAKAD</a>
                                <a href="<?= base_url('base/arsip') ?>" class="block px-3 py-2 text-gray-600 hover:bg-amber-50 hover:text-amber-600 rounded-md">Arsip</a>
                            </div>
                        </div>
                        
                        <a href="<?= base_url('base/kontak') ?>" class="block px-3 py-2 text-gray-700 hover:bg-amber-50 hover:text-amber-600 rounded-md">Kontak</a>
